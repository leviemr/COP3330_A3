...
public class CAI5
{
    ...
    //Declares ints, and inits random ints
       ...
       while (i < 10)
       {
    	   ...
    	   product = askQuestion(x, y, problemType);
           answer = readResponse();
	...
	//Asks user to respond to questions
	public static int askQuestion(int x, int y, int problemType)
	{
		int product = 0;
	...
	{
		System.out.printf("Select the problem type you would like to solve.\n");
